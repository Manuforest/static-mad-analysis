...
`specific detail -> viewing effect -> judgment -> relation to the work as a whole`

Allow the prose to spend unequal space on what matters. Do not force balanced praise and criticism, equal paragraph lengths, or coverage of picture, music, editing, story, theme, and technique as separate headings.
...
- Let sentence and paragraph length vary with the thought. Keep the prose controlled rather than deliberately messy.
...
Do not turn isolated sync points into a claim about the whole work. Show recurrence, development, contrast, or a consequential exception.

## Avoid generic analysis texture

Rewrite or remove:

- “This work uses X to successfully create Y” without a specific mechanism;
- “In terms of visuals / music / editing” as a repeated section formula;
- “not only... but also...” symmetry used to inflate a simple point;
- “worth mentioning,” “highly infectious,” “delicate,” “profound,” or “shocking” without observable support;
...
- Does each paragraph contain something specific to this work?
- Can each major judgment be traced to the shot reading?
- Does the response have a real center of gravity rather than complete category coverage?
- Have source qualities and editorial decisions been attributed separately?
